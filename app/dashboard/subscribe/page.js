  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      <div className="card glow-border p-6 mb-5 text-center relative overflow-hidden">
        ...
        <div className="text-3xl font-bold text-slate-900 mb-0.5">$399 <span className="text-lg text-slate-400 font-normal">USDT</span></div>
        <div className="text-sm text-slate-500 mb-4">6 months access — $66.50/mo</div>
      ...
      {!sub || ['failed','expired'].includes(status) ? (
        ...
        <div className="card glow-border p-5 space-y-4">
          ...
          <button onClick={subscribe} disabled={creating}
            ...
            {creating ? 'Generating address...' : 'Subscribe Now — $399 USDT'}
          </button>
        </div>
