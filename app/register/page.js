...
import { Zap, Mail, Lock, User, Eye, EyeOff, AlertCircle, CheckCircle, Hash } from 'lucide-react';
...
function RegisterForm() {
  ...
  async function handleSubmit(e) {
    ...
    setSuccess(`Account created! Your referral code: ${data.referralCode}`);
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input className="input pl-10 pr-12" type={showPass ? 'text' : 'password'} placeholder="Min 6 characters"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input className="input pl-10" type="text" placeholder="ABCD1234"
                    value={form.referralCode} onChange={e => setForm({ ...form, referralCode: e.target.value.toUpperCase() })} />
                </div>
              </div>

              <button type="submit" disabled={loading} className="btn-primary w-full py-3 text-sm mt-1 disabled:opacity-60">
